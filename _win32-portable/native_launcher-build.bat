...
g++ -Wall -Wextra -Wno-unused-parameter -pedantic -pipe -Os -fomit-frame-pointer -static-libgcc -static-libstdc++ -mwindows -Wl,--gc-sections -ffunction-sections -fdata-sections -o %LAUNCHER_OUTPUT_APP% %LAUNCHER_OUTPUT_RES% %LAUNCHER_SOURCE%
